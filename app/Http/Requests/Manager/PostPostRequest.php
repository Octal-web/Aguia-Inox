...
class PostPostRequest extends FormRequest
{
    ...
    {  
        return [
            'titulo' => 'required',
            'previa' => 'required',
            'destaque' => 'required|in:principal,secundario,nenhum',
            'conteudo' => 'required',
            'publicado'  => 'nullable|date_format:Y-m-d\TH:i',
            'case_destaque' => 'boolean',
    ...
    public function messages()
    {
        return [
            ...
            'destaque.required' => 'Por favor, informe a tipo de destaque.',
            'destaque.in' => 'Por favor, informe um destaque válido.',
            'conteudo.required' => 'Por favor, informe o conteúdo.',
            'publicado.date_format' => 'O formato de data é inválido.',
            'case_destaque.boolean' => 'O campo destaque deve ser verdadeiro ou falso.',
