...
class ContatoController extends Controller
{
    ...
    public function index() {
        ...
        $departamentos = Departamento::query()
            ...
            ->with([
                'departamentosIdiomas' => function ($q) {
            ...
            ->map(function($departamento) {
                return [
                    'id' => $departamento->id,
                    'visivel' => $departamento->visivel,
                    'nome' => (($departamento->departamentosIdiomas->isNotEmpty() ? $departamento->departamentosIdiomas[0]->nome : null)),
                ];
            });
