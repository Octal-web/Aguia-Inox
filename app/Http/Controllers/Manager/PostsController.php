...
class PostsController extends Controller
{
    ...
    public function novo(PostPostRequest $request) {
        if($request->ajax()){
            ...
            $post->case_destaque = $request->case_destaque ? true : false;
            ...
            if ($response) {
                ...
                return to_route('Manager.News.index')->with('message', ['type' => 'success', 'msg' => 'Registro salvo com sucesso!']);
            }
        }
    }
    ...
    public function editar($id) {
        ...
        if(!$post) {
            return Inertia::location(route('Manager.News.index'));
        }
        ...
        $post = [
            ...
            'case_destaque' => $post->case_destaque ? true : false,
    ...
    public function atualizar(PostPostRequest $request, $id) {
        if($request->ajax()){
            ...
            if (!$post) {
                return to_route('Manager.News.index')->with('message', ['type' => 'error', 'msg' => 'Não foi possível salvar as informações. Tente novamente mais tarde.']);
            }
        ...
        return to_route('Manager.News.index')->with('error', ['type' => 'success', 'msg' => 'Não foi possível salvar as informações. Tente novamente mais tarde.']);
    }
