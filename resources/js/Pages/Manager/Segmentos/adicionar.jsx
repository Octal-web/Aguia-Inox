...
const Page = () => {
    ...
    const inputItems = [
        [{ titulo: 'Nome', name: 'nome', tamanho: 'col-span-10 lg:col-span-6', tipo: 'texto', max: 120 }, { titulo: 'Destaque', name: 'destaque', tamanho: 'col-span-2 lg:col-span-2', tipo: 'check' }],
        ...
        [{ titulo: 'Imagem', name: 'img', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'imagem', crop: true, largura: 1280, altura: 720 }, { titulo: 'Banner', name: 'img_banner', tamanho: 'col-span-12 md:col-span-6', tipo: 'imagem', crop: true, largura: 650, altura: 226 }],
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Manager.Segmentos.novo'), {
            preserveScroll: true
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faEarthAmericas} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
