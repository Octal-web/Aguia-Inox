...
const Page = () => {
    ...
    const inputItems = [
        ...
        [
            ...
            { titulo: 'Poster Vídeo', name: 'img', tamanho: 'col-span-12 md:col-span-6', tipo: 'imagem', crop: true, largura: 1176, altura: 450 }
        ],
        [{ titulo: 'Imagem Selo', name: 'img_stamp', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'imagem', crop: false, largura: 280, altura: 280 }]
    ];
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faNoteSticky} items={breadcrumbItems} current="Adicionar" idioma={idioma.codigo} />
