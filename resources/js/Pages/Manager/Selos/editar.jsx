...
import { faNoteSticky, faSave, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
...
const Page = () => {
    const { idioma, idiomas, selo } = usePage().props;

    const { data, setData, post, processing, errors } = useForm(selo);

    const breadcrumbItems = [
        { label: 'Institucional', link: 'Manager.Institucional.index' },
        { label: 'Selos', link: 'Manager.Institucional.index' },
    ];
    ...
    const inputItems = [
        ...
        [
            { titulo: 'Vídeo', name: 'vid', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'video', arquivo: route('Manager.Selos.baixarVideo', { id: selo.id }) },
            { titulo: 'Poster Vídeo', name: 'img', tamanho: 'col-span-12 md:col-span-6', tipo: 'imagem', crop: true, largura: 1176, altura: 450, imagem: selo.imagem }
        ],
        [{ titulo: 'Imagem Selo', name: 'img_stamp', tamanho: 'col-span-12 md:col-span-6 lg:col-span-4', tipo: 'imagem', crop: false, largura: 280, altura: 280, imagem: selo.selo }]
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(route('Manager.Selos.atualizar', {id: selo.id, lang: idioma_url}), {
            preserveScroll: true,
        });
        console.log(data);
    ...
    return (
        <AdminLayout>
            <Breadcrumb icon={faNoteSticky} items={breadcrumbItems} current="Editar" idioma={idioma.codigo} idiomas={idiomas} id={selo.id} />
