...
const Login = () => {
    ...
    return (
        <AuthLayout>
            <div className="min-h-screen flex flex-col justify-center items-center bg-secondary text-white">
                <div className="w-full max-w-[400px] animate-fade-in-down">
                    <div className="p-8 space-y-8 bg-white bg-opacity-10 rounded-lg shadow-lg">
                        <div className="flex justify-center">
                            <img src={`/admin/img/logo.png`} className="" />
                        </div>
                            ...
                            <div className="rounded-md shadow-sm -space-y-px">
                                <div className="mb-5">
                                    ...
                                    <input
                                        ...
                                        name="email"
                                        type="text"
                                        className="appearance-none rounded relative block w-full px-3 py-2 text-sm border border-gray-300 placeholder-gray-500 text-gray-900 focus:ring-primary focus:border-secondary focus:ring-indigo-500"
                                        placeholder="E-mail"
                                        value={data.email}
                    ...
                    <div className="mt-6 text-center text-sm text-gray-400">
                        &copy; {currentYear} Águia Inox. Desenvolvido por Octal Web.
                    </div>
                </div>
            </div>
        </AuthLayout>
