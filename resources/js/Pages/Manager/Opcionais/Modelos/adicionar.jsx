...
const Page = () => {
    const { opcional, idioma } = usePage().props;
    ...
    const breadcrumbItems = [
        ...
        { label: 'Editar Opcional', link: 'Manager.Opcionais.editar', params: { id: opcional.id }},
        { label: 'Modelos', link: 'Manager.Opcionais.Modelos.index', params: { id: opcional.id }},
    ];
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Manager.Opcionais.Modelos.novo', {id: opcional.id}), {
            preserveScroll: true
        });
        console.log(data);
                ...
                <div className="mt-10">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-end">
                            <Link href={route('Manager.Opcionais.Modelos.index', {id: opcional.id})} className="flex items-center w-fit rounded-lg border border-red-700 text-red-700 px-3 py-2 mr-3 cursor-pointer transition-all hover:bg-red-100">
