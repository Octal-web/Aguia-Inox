...
const Page = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('Manager.Departamentos.novo'), {
            preserveScroll: true
        });
        console.log(data);
                ...
                <div className="mt-10">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-end">
                            <Link href={route('Manager.Contato.index')} className="flex items-center w-fit rounded-lg border border-red-700 text-red-700 px-3 py-2 mr-3 cursor-pointer transition-all hover:bg-red-100">
