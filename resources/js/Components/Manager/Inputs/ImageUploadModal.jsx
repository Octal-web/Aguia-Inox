...
function ContextMenu({ x, y, file, onAction, onClose }) {
    ...
    return (
        ...
        >
            ...
            ${item.danger ? "text-red-500 hover:bg-red-50" : item.highlight ? "text-blue-600 font-semibold hover:bg-blue-50" : "text-gray-700 hover:bg-gray-100"}`}
                >
                    {item.label}
                </button>
            ))}
...
function DropZone({ onDrop, children, highlight, onHighlight }) {
    return (
        <div
            ...
            className={`h-full transition-all duration-150 ${highlight ? "ring-2 ring-inset ring-blue-400 bg-blue-50/40" : ""}`}
        >
            {children}
        </div>
    );
            ...
            <div>
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        disabled={!isValidUrl}
                        className="px-4 py-2 text-sm text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-40 disabled:cursor-not-allowed rounded-xl transition-colors font-medium shadow-sm"
                    >
                        Inserir
                    </button>
                </div>
                    ...
                    <>
                        <div className="flex items-center gap-2 px-4 py-2.5 border-b border-gray-100 bg-gray-50/60">
                            ...
                            <div className="flex items-center gap-1.5 flex-shrink-0">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors font-medium shadow-sm"
                                >
                                    <svg
                                        viewBox="0 0 20 20"
                                        fill="currentColor"
                        ...
                        >
                            <div className="flex-1 overflow-y-auto px-3 py-2 h-full">
                                ...
                                ${selected === file.id ? "bg-blue-50 ring-1 ring-blue-200" : "hover:bg-gray-50"}
                                ${dropTarget === file.id ? "ring-2 ring-blue-400 bg-blue-50" : ""}
                              `}
                                                        >
                                                            <FileIcon
                                                                file={file}
                                                            ...
                                                            <button
                                                                ...
                                                                className="opacity-0 group-hover:opacity-100 text-xs text-blue-500 hover:text-blue-700 px-2 py-0.5 rounded-lg hover:bg-blue-100 transition-all"
                                                            >
                                                                Abrir →
                                                            </button>
                                                        </div>
                                                        ...
                                                        >
                                                            ...
                                                            {isImage(
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="opacity-0 group-hover:opacity-100 text-xs text-white bg-blue-600 hover:bg-blue-700 px-2.5 py-1 rounded-lg transition-all shadow-sm"
                                                                >
                                                                    Selecionar
                                                                </button>
                                                            )}
