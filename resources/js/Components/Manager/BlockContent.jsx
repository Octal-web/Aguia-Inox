                ...
                {content.editavel ? (
                    ...
                    >
                        {state.map((conteudo, index) => (
                            <div key={index} className="relative rounded-md border border-stroke p-4 shadow-sm select-none before:content-[''] before:absolute before:top-0 before:left-0 before:bg-secondary before:w-full before:h-1 before:rounded-t-md">
                                <IndividualContent 
