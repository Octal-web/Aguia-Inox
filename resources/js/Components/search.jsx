...
export function Search() {
    ...
    return (
        <div className="absolute top-[80px] md:top-[110px] 2xl:top-[134px] left-0 z-50 h-[130px] w-full border-t-2 border-b-4 border-primary bg-[#EDF1F8] pt-12 md:pt-20 pb-11 shadow-lg">
